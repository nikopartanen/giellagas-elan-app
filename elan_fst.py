# 2023-11-02
# This code originates from the repository
# https://github.com/langdoc/elan-fst/blob/master/annotate_elan_oulu.py
# for further information, see that repository
